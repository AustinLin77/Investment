      ...
      <el-row :gutter="20" >
        <el-col :span="8">
          <div class="grid-content bg-purple">
            ...
            <el-form :model="ruleFormOne" :rules="rulesaa" ref="ruleFormOne" label-width="100px" class="demo-ruleForm">
              ...
              <el-form-item label="投资年限 :" prop="region">
        ...
        <el-col :span="8">
          <div class="grid-content bg-purple">
            ...
            <el-form :model="ruleFormThree" :rules="rulesaa" ref="ruleFormThree" label-width="100px" class="demo-ruleForm">
              ...
              <el-form-item label="基础短信服务 :" prop="firstServe" :inline="true">
              ...
              <el-form-item label="可选短信服务 :" prop="secondServe" :inline="true">
